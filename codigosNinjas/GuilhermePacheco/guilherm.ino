...
void loop () {
    ...
    if (menorDist >= 100) {
        ...
        // Decide curva, se menor distancia menor que 50
        ...
        if (menorDist > 45) {
            ...
            // Aproximando da diagonal, vira rapidamente para a direita
